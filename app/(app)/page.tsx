  ...
  return (
    <div>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <Link
          href="/placements"
          className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition hover:border-slate-300 hover:shadow dark:border-slate-800 dark:bg-slate-900 dark:hover:border-slate-600"
        >
